...
if __name__ == "__main__":
    ...
    for training_period in range(10, 50, 5):  # 10 loops
        ...
        for standard_deviation in range(2, 4):
            ...
            if (
                ...
                df.to_csv(
                    "results/Test_Results_rsi_ibs2.csv",
                    mode="a",
                    header=True,
                    index=False,
                )
            ...
            for rolling_average in [2, 3, 5, 10]:  # 4 loops
                if rolling_average < training_period:
                    ...
                    if training_period == 2 and offset == -10 and rolling_average == 2:
                        df.to_csv(
                            "results/Test_Results_Stochastic2.csv",
                            mode="a",
                            header=True,
                            index=False,
                        )
    ...
    print("starting bb_rsi_longs_only")
    for training_period in range(2, 50, 5):  # 10 loops
        # print("time taken: ", time.time() - starttime)
        # print("Training period: " + str(training_period))
        # print(
        ...
        for standard_deviation in range(1, 3):  # 5 loops
            ...
            for offset in range(-10, 11, 10):  # 3 loops
                ...
                if training_period == 2 and offset == -10 and standard_deviation == 1:
                    df.to_csv(
                        "results/Test_Results_BB_RSI_Longs2.csv",
                        mode="a",
                        header=True,
                        index=False,
                    )
    ...
    print("starting bb_rsi_stoch")
    for training_period in range(
        20, 50, 5
    ):  # 10 loops fgreggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggg
        # for training_period in range(14, 15, 5):  # 10 loops
        # print("time taken: ", time.time() - starttime)
        # print("Training period: " + str(training_period))
        # print(
                ...
                for k_period in range(8, 21, 6):  # 5 loops
                    ...
                    if k_period < training_period:
                        ...
                        if (
                            ...
                            df.to_csv(
                                "results/Test_Results_bb_rsi_stoch2.csv",
                                mode="a",
                                header=True,
                                index=False,
                            )
    ...
    for training_period in range(2, 50, 5):  # 10 loops
        ...
        for offset in range(-10, 11, 10):  # 3 loops
            ...
            for rolling_average in [2, 3, 5, 10]:  # 4 loops
                ...
                if training_period == 2 and offset == -10 and rolling_average == 2:
                    df.to_csv(
                        "results/Test_Results_RSI_Stochastic2.csv",
                        mode="a",
                        header=True,
                        index=False,
                    )
